...
internal object RemoteSettingSyncController {
    ...
    fun synchronization(synchronized: (success: Boolean) -> Unit) {
        CoreDataContract(blockCode = FeatureCore.coreBlockCode).let { core ->
